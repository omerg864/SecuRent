		...
		<main className="container mx-auto px-4">
			<div className="flex justify-between items-center mb-8">
				...
				<div className="flex gap-3">
					{['Delete', 'Update', 'Suspend'].map((label) => (
						<button
							key={label}
							className="border border-black text-black hover:bg-gray-100 px-4 py-1.5 rounded-md text-sm font-medium transition min-w-[100px] text-center"
						>
							{label}
						</button>
					))}
