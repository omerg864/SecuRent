...
export default function SingleReport() {
    ...
    const handleAdminClick = () => {
        // temporarily alerting instead of navigating
        // when Admin page will be ready, use: navigate(`/admin/${report.resolutionBy._id}`);
        alert("Admin profile page is coming soon!");
    };
