    ...
    <SafeAreaView className="flex-1 bg-gray-100">
      ...
      <FloatingBackArrowButton
        from={
          typeof from === "string"
            ...
            : (`/${
                accountType === "personal" ? "customer" : "business"
      ...
      >
        <View className="items-center mb-8 mt-2">
          ...
          {accountType === "business" && transaction.customer?.email && (
            <ConfirmEmailLink
        ...
        <View className="mb-6 bg-gray-50 rounded-lg py-4">
          <Row
            label="Start Date"
            value={new Date(transaction.createdAt).toLocaleDateString("en-GB")}
          />
          <Row
            label="Start Time"
            ...
            <Row
              ...
              value={
                transaction.closed_at
                  ? new Date(transaction.closed_at).toLocaleDateString("en-GB")
                  : "-"
              }
            />
            <Row
              ...
              value={
                transaction.closed_at
                  ? new Date(transaction.closed_at).toLocaleTimeString(
                      "en-GB",
                      {
                        hour: "2-digit",
                        minute: "2-digit",
