...
export default function TransactionDetails() {
  ...
  const profileImage =
    transaction.customer?.image || transaction.business?.image;
  ...
  const displayName =
    transaction.customer?.name || transaction.business?.name || "Unknown";
    ...
    <SafeAreaView className="flex-1 bg-white">
      ...
      <ScrollView className="flex-1 px-6">
        <View className="items-center mb-8 mt-2">
          <View className="w-16 h-16 rounded-full bg-blue-100 items-center justify-center mb-2 overflow-hidden">
            {profileImage ? (
              <Image
          ...
          <Text className="text-lg font-medium text-black">{displayName}</Text>
        </View>
