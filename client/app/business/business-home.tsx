      ...
      <ScrollView className="flex-1 px-4">
        ...
        <View className="bg-white rounded-xl overflow-hidden shadow-lg">
          <View className="flex-row justify-between items-center py-4 px-4 border-b border-gray-200">
            <ThemedText style={{ color: "black" }} className="text-lg font-semibold">
              Active Transactions
            </ThemedText>
          ...
          {transactions.map((transaction) => (
            ...
            >
              <View className="flex-1">
                <ThemedText style={{ color: "black" }} className="text-base font-medium mb-1">
                  {transaction.name}
                </ThemedText>
              ...
              <ThemedText style={{ color: "black" }} className="text-base font-semibold">
                {transaction.amount}
              </ThemedText>
            </TouchableOpacity>
          ))}
